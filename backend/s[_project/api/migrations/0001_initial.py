# Generated by Django 4.2.16 on 2024-11-19 08:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measurement_unit', models.CharField(choices=[('кг', 'Килограммы'), ('г', 'Граммы')], default='кг', max_length=2, verbose_name='Единица измерения')),
            ],
            options={
